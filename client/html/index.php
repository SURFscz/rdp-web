...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            const Tunnel = new Guacamole.WebSocketTunnel("wss://<?php echo $_SERVER['URL_GUACD']; ?>");
            const client = new Guacamole.Client(Tunnel);
            
            var connected = false;
            var dis = client.getDisplay().getElement();
            var context;

            document.getElementById('connect').addEventListener('click', function() {
                if (! connected) {
                   client.connect('token=<?php echo base64_encode($json); ?>&width='+WIDTH+'&height='+HEIGHT+'&dpi=96&GUAC_AUDIO=audio/L8&GUAC_AUDIO=audio/L16');
                }
            });
